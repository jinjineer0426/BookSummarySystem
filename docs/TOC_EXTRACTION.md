...
Gemini 2.5の `response_schema` 機能を使用し、出力時のJSON構造を強制しています。これにより、以下のような生成エラーを防いでいます：

- `Unterminated string` (途切れ)
- JSON構文エラー
- 予期しないフィールドの混入
